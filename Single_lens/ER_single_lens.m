...
clear all;
close all;
folderpath = 'D:\Research_implementations\Paper_12\Single lens\Output\ER';
...
autocorrel=real(ifft2(((abs(fft2(fx)).^2))));
figure 
